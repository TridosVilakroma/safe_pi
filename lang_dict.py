...
DISABLE for 3 seconds.
  [/color][/size]""",
    ...
    'custom_logic_overlay' : 'Custom Logic',
    'custom_logic_text_enable' : '[size=30][color=#000000]Enable [/color][/size]',
    'custom_logic_text_disable' : '[size=30][color=#000000]Disable [/color][/size]',
    'custom_logic_text' : '[size=30][color=#000000]Custom Logic Packages?[/color][/size]',
    'custom_logic_confirm' : '[size=30][b][color=#000000] Continue [/color][/b][/size]',
    'custom_logic_cancel' : '[size=30][b][color=#000000] Cancel [/color][/b][/size]',
